...
export default function TendinaLateraleAgente() {
  const icone = [
    { icon: <User />, href: '/homeAgente', attiva: true },
          ...
          <Link key={i} href={item.href}>
            <div
              className={`p-2 rounded ${
                item.attiva ? 'bg-blue-500 text-white shadow-md' : 'text-gray-400 hover:text-blue-400'
              }`}
            >
              {item.icon}
            </div>
